...
private fun EmptyConversations(
    ...
    Column(
        modifier = Modifier
            .fillMaxSize()
            // Two stacked panels overrun the viewport on a 412×892
            // device once the toolbar and bottom nav take their cut,
            // so the security baseline needs to be scrollable to.

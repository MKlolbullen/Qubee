...
impl ZKProofGenerator {
    ...
    fn generate_schnorr_proof(
        ...
        let private_key = self.identity_keypair.classical_private_bytes();
        let _challenge_scalar = SigningKey::from_bytes(&challenge);
    ...
    fn generate_pq_proof(
        ...
        hasher.update(self.identity_keypair.pq_private_bytes());
...
impl ZKProofVerifier {
    ...
    pub fn verify_qr_proof(
        ...
        use base64::Engine as _;
        let compressed_data = base64::engine::general_purpose::STANDARD.decode(qr_data)
    ...
    fn is_replay_attack(&self, _nonce: &[u8; 32]) -> Result<bool> {
